 ...
 * <P>
 * <HR>
 * Last functional change: 3.5.2005 (2.0b6)<BR>
...
public interface DeepaMehtaConstants {
	...
	static final String CLIENT_VERSION = "2.0b6";
	static final String SERVER_VERSION = "2.0b6";
	static final String REQUIRED_SERVER_VERSION = "2.0b6";
	static final int REQUIRED_STANDARD_TOPICS = 15;
	static final int REQUIRED_DB_MODEL = 2;
	static final int REQUIRED_DB_CONTENT = 15;
	// --- application server ---
	...
	static final int YEAR_MIN = 1911;
	static final int YEAR_MAX = 2006;
	...
	static final String ASSOCTYPE_ASSOCIATION = "at-association";
