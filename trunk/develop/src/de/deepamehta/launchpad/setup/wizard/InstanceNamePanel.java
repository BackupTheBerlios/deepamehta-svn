...
public class InstanceNamePanel extends AbstractWizardPanel {
	...
	private  void initialize() {
		...
		this.labelID.setText(Messages.getString("InstanceNamePanel.ID")); //$NON-NLS-1$
		...
		this.labelDescription.setText(Messages.getString("InstanceNamePanel.Description")); //$NON-NLS-1$
	...
	private JPanel getPanelTitle() {
		if (this.panelTitle == null) {
			...
			this.labelTitle.setText(Messages.getString("InstanceNamePanel.Title")); //$NON-NLS-1$
	...
	private JTextArea getTaGlobalExplanation() {
		if (this.taGlobalExplanation == null) {
			...
			this.taGlobalExplanation.setText(Messages.getString("InstanceNamePanel.GlobalExplanation")); //$NON-NLS-1$
	...
	private JTextArea getTaIDExplanation() {
		if (this.taIDExplanation == null) {
			...
			this.taIDExplanation.setText(Messages.getString("InstanceNamePanel.IDExplanation")); //$NON-NLS-1$
	...
	private JTextArea getTaDescriptionExplanation() {
		if (this.taDescriptionExplanation == null) {
			...
			this.taDescriptionExplanation.setText(Messages.getString("InstanceNamePanel.DescriptionExplanation")); //$NON-NLS-1$
