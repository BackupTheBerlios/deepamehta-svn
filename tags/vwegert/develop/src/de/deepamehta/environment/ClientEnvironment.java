...
/**
 * MISSDOC No documentation for type ClientEnvironment
 * @author vwegert
 *
 */
public class ClientEnvironment extends AbstractEnvironment {
    ...
    private static Log logger = LogFactory.getLog(ClientEnvironment.class);
